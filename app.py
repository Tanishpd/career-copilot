...
app.config['MYSQL_PASSWORD'] = 'Pavan@22'
app.config['MYSQL_DB'] = 'quizapp'
app.config['MYSQL_CURSORCLASS'] = 'DictCursor'

app.config['MAIL_SERVER']='smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USERNAME'] = 'pavankumarps152@gmail.com' # Replace with your Gmail address
app.config['MAIL_PASSWORD'] = 'wuljplvxxttgcjej' # Fixed spaces/typo
...
sender = 'pavankumarps152@gmail.com'
...
def calculate_ats_score():
    ...
    try:
        ...
        # Let's reuse the key we saw in logs: AIzaSyDh14RYxjiIlmqSzRRqBA2Bozv1KVyN5I4
        
        api_key = "AIzaSyDh14RYxjiIlmqSzRRqBA2Bozv1KVyN5I4" 
